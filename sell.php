...
<div style=" padding: 10px; background-color: #D6D6D6; border-radius: 15px;" >
     <div class="flex-center flex-column" style="background-color: transparent;">
     
                <h2 class="animated fadeIn mb-4" ><u>Compliments and complaints.</u></h2>
                ...
                <h5 class="animated fadeIn mb-3">We are glad that you chose our community.</h5>
...
<form action="phpFile.php" id="feedback">
<fieldset>
<legend>  Sugestion or complaint information: </legend>

  Type of feed-back: <br>
  
  <select name="type" form="feedback" style="width: 200px;">
     ...
     <option value="sugestion"> sugestion </option>
      ...
      <br><br>
             ...
             Name:  <br>
  <input type="text" name="name" value="" placeholder="name" style="width: 200px;" >
...
Phone number: 
 <br>
  <input type="text" name="phone" value="" placeholder="xxxx xxx xxx" style="width: 200px;">
  
  <br><br>
  
  e-mail: <br>
  <input type="email" name="email" value="" placeholder="xxxx@yyyy.zz" style="width: 200px;"> 
  
  <br><br> 
  
   message:
<br>
 <textarea name="message" placeholder="Hey guys..." form="feedback" style="width: 600px; height: 200px" class="center"></textarea>
